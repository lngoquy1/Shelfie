...
public class BookInfoTests {
    ...
    public void testNonExceptionGetters() throws IOException, ParserConfigurationException, XPathExpressionException, SAXException, NotFoundException, EmptyQueryException {
        ...
        Assert.assertEquals("Transworld Publishers", publisher);
        int pages = bookInfo.getNumPagesFromISBN("0552547344");
        Assert.assertEquals(271, pages);
        int pages2 = bookInfo.getNumPagesFromISBN("0439554934");
...
//        for (String title:expectedList){
//            SimpleBook simpleBook = bookInfo.populateSimpleBookFromTitleAndOrAuthor(title, "");
//            if (simpleBook != null){
//                newList.add(simpleBook);
//            }
//        }
